                ...
                <c:when test="${!empty user }">
                    <div style="padding-top: 200px;">
                        ...
                        <button type="button" class="btn btn-primary" id="addbtn"
                                onclick="doClick()" style="float: right;">发布
                        </button>
        ...
        <div class="col-md-4">
            ...
            <div style="padding-top: 120px;">
                <center>
                    <c:choose>
                        <c:when test="${empty user }">
                            <img src="<c:url value="/resources/imgs/default.jpg"/>" class="img-circle"
                                 data-toggle="modal" data-target="#login">
                            <br><br>用户名：
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#login">未登录</a>
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#register">注册</a>
                        </c:when>
                        <c:otherwise>
                            <a href="${pageContext.request.contextPath}/user/manager/${user.userId }" target="_blank">
                                <img alt="${user.username }" src="<c:url value="${user.heading }"/>" class="img-circle"
